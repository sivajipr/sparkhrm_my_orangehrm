"""
Django settings for spark_hrm project.
...
SECRET_KEY = '%w7_=1veda8_jw%s2q^xfi4paj1%r&-)%&iu9ot-9)(dz#5bvz'
...
ROOT_URLCONF = 'spark_hrm.urls'

WSGI_APPLICATION = 'spark_hrm.wsgi.application'
